...
set(hObject,'Position',[103.8571 47.1765 74 12.2941]);
set(handles.visualize_load_form,'Position',[103.8571 47.1765 74 12.2941]);
set(handles.button_load_from_file,'Position',[2 1 17 2]);
set(handles.button_cancel,'Position',[57 1 15 2]);
set(handles.text1,'Position',[2 10.4615 31.8 1.1538]);
set(handles.button_load,'Position',[39.4 1 15 2]);
set(handles.listbox_variables,'Position',[1.8 3.8462 70.2 6.6154]);
