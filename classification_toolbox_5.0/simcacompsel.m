function res = simcacompsel(X,class,pret_type,cv_type,cv_groups)

% selection of the optimal number of components for SIMCA
% by means of cross-validation
%
% res = simcacompsel(X,class,pret_type,cv_type,cv_groups)
%
% input:
...
for k = 1:r
    ...
    elseif getappdata(hwait,'canceling')
        ...
        out = simcacv(X,class,num_comp,pret_type,cv_type,cv_groups,'class modeling');
